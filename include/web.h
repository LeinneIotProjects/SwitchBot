...
<head>
    ...
    <title>Switch Bot WiFi Settings</title>
    <style>
        tr > td > input{
            padding: 0;
            width: 100%;
...
<body>
    <h1><center>Switch Bot WiFi Settings</center></h1>
...
<body>
    <center>
        <h1>Switch Bot WiFi Settings</h1>
        <div>Switch Bot WiFi AP settings have been successful.</div>
    </center>
</body>
</html>
)rawliteral";
